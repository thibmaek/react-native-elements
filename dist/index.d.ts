...
declare const AirbnbRating: import("react").FunctionComponent<Pick<TapRatingProps, "size" | "count" | "reviews" | "showRating" | "reviewColor" | "reviewSize" | "defaultRating" | "starContainerStyle" | "onFinishRating" | "isDisabled" | "selectedColor" | "starImage">> | import("react").ForwardRefExoticComponent<TapRatingProps>;
declare const Rating: import("react").ForwardRefExoticComponent<any> | import("react").FunctionComponent<Pick<any, string | number | symbol>>;
